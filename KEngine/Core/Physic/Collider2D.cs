...
namespace KEngine.Core {
    public class Collider2D : Component, IPositionChangeHandler, IDrawable {

        public BoundingBox2D bound = new BoundingBox2D();
        public Rectangle rect = new Rectangle();
        public Texture2D colliderTexture = new Texture2D(CoreGame.graphicsDeviceManager.GraphicsDevice, 1, 1);
        ...
        public void Draw() {
            CoreGame.spriteBatch.Draw(colliderTexture, rect, Color.White);
        }
